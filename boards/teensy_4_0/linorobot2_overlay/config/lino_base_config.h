...
#define COUNTS_PER_REV1 1024                // wheel1 encoder's no of ticks per rev
#define COUNTS_PER_REV2 1024                // wheel2 encoder's no of ticks per rev
...
#define BAUDRATE 115200                     // micro-ROS serial baud (l'agent tourne a 115200)
